...
__bound_check5:
  ...
  %rvtable46 = load i8** %rvtable43
  %lvtable44 = load i8** %cast_op47
  %compare45 = icmp eq i8* %rvtable46, null
  br i1 %compare45, label %__end_no8, label %__check_curr7
...
__check_curr7:
  ...
  br i1 %compare45, label %__end_yes9, label %__move_up6
...
__end_yes9:
  ...
  %lhs_or_call37 = load %C** %cast_ptr34
...
__end_no8:
  ...
  %lhs_or_call40 = load %A** %vdecl_slot31
  %i41 = getelementptr %A* %lhs_or_call40, i32 0, i32 2
  %lhs_or_call42 = load i32* %i41
  store i32 %lhs_or_call42, i32* %vdecl_slot33
  %lhs_or_call48 = load i32* %vdecl_slot33
  ret i32 %lhs_or_call48
}
