...
__body307:
  ...
  %i1306 = getelementptr %A* %lhs_or_call1305, i32 0, i32 0, i32 2
...
__fresh305:
  ...
  %_name1271 = getelementptr %C* %_this1, i32 0, i32 0, i32 1
  ...
  %i1267 = getelementptr %C* %_this1, i32 0, i32 0, i32 2
...
__fresh304:
  ...
  %_name1265 = getelementptr %B* %_this1, i32 0, i32 0, i32 1
  ...
  %i1261 = getelementptr %B* %_this1, i32 0, i32 0, i32 2
...
__fresh303:
  ...
  %_name1259 = getelementptr %A* %_this1, i32 0, i32 0, i32 1
  ...
  %i1255 = getelementptr %A* %_this1, i32 0, i32 0, i32 2
...
__fresh302:
  %_name1253 = getelementptr %Object* %_this1, i32 0, i32 0, i32 1
...
__fresh301:
  %_name1251 = getelementptr %Object* %_this1, i32 0, i32 0, i32 1
