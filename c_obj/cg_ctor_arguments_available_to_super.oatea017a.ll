...
@_const_str7.str. = private unnamed_addr constant [ 2 x i8 ] c "B\00", align 4
@_const_str7 = alias bitcast([ 2 x i8 ]* @_const_str7.str. to i8*)@_const_str5.str. = private unnamed_addr constant [ 13 x i8 ] c "printing x 
\00", align 4
@_const_str5 = alias bitcast([ 13 x i8 ]* @_const_str5.str. to i8*)@_const_str6.str. = private unnamed_addr constant [ 2 x i8 ] c "A\00", align 4
@_const_str6 = alias bitcast([ 2 x i8 ]* @_const_str6.str. to i8*)@_const_str4.str. = private unnamed_addr constant [ 7 x i8 ] c "Object\00", align 4
...
__fresh3:
  ...
  %new_obj28 = call %A* @_A_ctor ( %B* %obj27, %A* %cast_op25, i32 %bop24 )
  %_this1 = bitcast %A* %new_obj28 to %B 
  %_name29 = getelementptr %B* %_this1, i32 0, i32 1
  store i8* @_const_str7, i8** %_name29
...
__fresh2:
  ...
  store i8* @_const_str6, i8** %_name15
  ...
  call void @print_int( i32 %lhs_or_call10 )
  ret %A* %_this1
}
