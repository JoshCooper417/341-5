...
__fresh7:
  ...
  %vtable33 = getelementptr i32 (%A*, i32)** %over35, i32 0, i32 0
  %over35 = getelementptr %_A_vtable* %vtable33, i32 0, i32 2
  %over34 = load i32 (%A*, i32)** %over35
  %cast_op36 = bitcast %A %lhs_or_call32 to %A* 
  %ret37 = call i32 %over34 ( %A* %cast_op36, i32 3 )
  ret i32 %ret37
}
