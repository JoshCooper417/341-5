...
__fresh24:
  ...
  %i106 = getelementptr %B* %_this1, i32 0, i32 2
  %lhs_or_call107 = load i32* %i106
  %j108 = getelementptr %B* %_this1, i32 0, i32 3
...
__fresh22:
  ...
  %_name88 = getelementptr %B* %_this1, i32 0, i32 1
...
__fresh18:
  ...
  %_name68 = getelementptr %A* %_this1, i32 0, i32 1
  ...
  %i64 = getelementptr %A* %_this1, i32 0, i32 2
  store i32 1, i32* %i64
  ret %A* %_this1
}
