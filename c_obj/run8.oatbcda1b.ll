...
__fresh97:
  ...
  %f421 = getelementptr %_A_vtable* @_A_vtable77, i32 0, i32 2
  %f420 = load i32 (%A*)** %f421
  %cast_op422 = bitcast %A %lhs_or_call419 to %A* 
  %ret423 = call i32 %f420 ( %A* %cast_op422 )
  ret i32 %ret423
}
...
__fresh95:
  %cast_op402 = bitcast %A* %_this1 to %Object* 
  %mem_ptr403 = call i32* @oat_malloc ( i32 12 )
  %obj404 = bitcast i32* %mem_ptr403 to %A* 
  %new_obj405 = call %Object* @_Object_ctor ( %A* %obj404, %Object* %cast_op402 )
  ...
  %i401 = getelementptr %A* %_this1, i32 0, i32 2
  store i32 0, i32* %i401
  ret %A* %_this1
}
...
__fresh94:
  %_name399 = getelementptr %Object* %_this1, i32 0, i32 1
  %lhs_or_call400 = load i8** %_name399
  ret i8* %lhs_or_call400
}


define %Object* @_Object_ctor (%Object* %_this1){
__fresh93:
  %_name397 = getelementptr %Object* %_this1, i32 0, i32 1
  store i8* @_const_str78, i8** %_name397
  %this_vtable398 = getelementptr %Object* %_this1, i32 0, i32 0
  store %_Object_vtable* @_Object_vtable76, %_Object_vtable** %this_vtable398
  ret %Object* %_this1
}
