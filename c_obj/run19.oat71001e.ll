...
__fresh164:
  ...
  %str644 = getelementptr %B* %lhs_or_call643, i32 0, i32 0, i32 2
...
__fresh163:
  ...
  %_name633 = getelementptr %B* %_this1, i32 0, i32 0, i32 1
...
__fresh162:
  ...
  %_name623 = getelementptr %A* %_this1, i32 0, i32 0, i32 1
  store i8* @_const_str107, i8** %_name623
  %str624 = getelementptr %A* %_this1, i32 0, i32 0, i32 2
...
__fresh161:
  %_name616 = getelementptr %Object* %_this1, i32 0, i32 0, i32 1
...
__fresh160:
  %_name614 = getelementptr %Object* %_this1, i32 0, i32 0, i32 1
