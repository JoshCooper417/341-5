...
__fresh73:
  %x287 = getelementptr %A* %_this1, i32 0, i32 0, i32 2
...
__fresh72:
  ...
  %_name283 = getelementptr %A* %_this1, i32 0, i32 0, i32 1
  store i8* @_const_str48, i8** %_name283
  %x284 = getelementptr %A* %_this1, i32 0, i32 0, i32 2
...
__fresh71:
  %_name276 = getelementptr %Object* %_this1, i32 0, i32 0, i32 1
...
__fresh70:
  %_name274 = getelementptr %Object* %_this1, i32 0, i32 0, i32 1
