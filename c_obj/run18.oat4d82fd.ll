...
__fresh91:
  ...
  %str385 = getelementptr %A* %lhs_or_call384, i32 0, i32 0, i32 2
...
__fresh90:
  ...
  %_name372 = getelementptr %A* %_this1, i32 0, i32 0, i32 1
  store i8* @_const_str63, i8** %_name372
  %str373 = getelementptr %A* %_this1, i32 0, i32 0, i32 2
...
__fresh89:
  %_name365 = getelementptr %Object* %_this1, i32 0, i32 0, i32 1
...
__fresh88:
  %_name363 = getelementptr %Object* %_this1, i32 0, i32 0, i32 1
