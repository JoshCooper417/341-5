...
__fresh279:
  %_name1186 = getelementptr %Object* %_this1, i32 0, i32 1
  %lhs_or_call1187 = load i8** %_name1186
  ret i8* %lhs_or_call1187
}
...
__fresh278:
  ...
  store i8* @_const_str247, i8** %_name1184
  %this_vtable1185 = getelementptr %Object* %_this1, i32 0, i32 0
  store %_Object_vtable* @_Object_vtable246, %_Object_vtable** %this_vtable1185
  ret %Object* %_this1
}
