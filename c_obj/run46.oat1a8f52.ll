...
__fresh384:
  ...
  %s1595 = getelementptr %A* %ret1594, i32 0, i32 3
  ...
  %i1613 = getelementptr %A* %ret1612, i32 0, i32 2
  ...
  %i1640 = getelementptr %A* %ret1639, i32 0, i32 2
  ...
  %i1704 = getelementptr %A* %ret1703, i32 0, i32 2
  ...
  %s1714 = getelementptr %A* %ret1713, i32 0, i32 3
  ...
  %i1722 = getelementptr %S* %ret1721, i32 0, i32 2
  ...
  %s1738 = getelementptr %A* %ret1737, i32 0, i32 3
...
__fresh382:
  ...
  %_name1575 = getelementptr %B* %_this1, i32 0, i32 1
...
__fresh380:
  ...
  %_name1563 = getelementptr %A* %_this1, i32 0, i32 1
  store i8* @_const_str305, i8** %_name1563
  %s1564 = getelementptr %A* %_this1, i32 0, i32 3
  ...
  %i1559 = getelementptr %A* %_this1, i32 0, i32 2
...
__fresh377:
  ...
  %_name1553 = getelementptr %S* %_this1, i32 0, i32 1
  ...
  %i1549 = getelementptr %S* %_this1, i32 0, i32 2
...
__fresh375:
  %_name1542 = getelementptr %Object* %_this1, i32 0, i32 1
...
__fresh374:
  %_name1540 = getelementptr %Object* %_this1, i32 0, i32 1
