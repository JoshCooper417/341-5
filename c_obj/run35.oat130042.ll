...
__bound_check378:
  ...
  br i1 %compare1196, label %__end_no381, label %__check_curr380

__fresh387:
  br label %__check_curr380

__check_curr380:
  %compare1196 = icmp eq i8** %lvtable1195, %rvtable1197
  br i1 %compare1196, label %__end_yes382, label %__move_up379

__fresh388:
  br label %__move_up379
