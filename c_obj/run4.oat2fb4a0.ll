...
__fresh43:
  ...
  %mem_ptr178 = call i32* @oat_malloc ( i32 12 )
  %obj179 = bitcast i32* %mem_ptr178 to %A* 
  %new_obj180 = call %A* @_A_ctor ( %A* %obj179 )
  %vdecl_slot181 = alloca %A*
  store %A* %new_obj180, %A** %vdecl_slot181
  %lhs_or_call182 = load %A** %vdecl_slot181
  %i183 = getelementptr %A* %lhs_or_call182, i32 0, i32 2
  %lhs_or_call184 = load i32* %i183
  ret i32 %lhs_or_call184
}
...
__fresh42:
  ...
  %_this1 = bitcast %Object* %new_obj171 to %A 
  %_name172 = getelementptr %A* %_this1, i32 0, i32 1
  store i8* @_const_str31, i8** %_name172
  %this_vtable173 = getelementptr %A* %_this1, i32 0, i32 0
  store %_A_vtable* @_A_vtable29, %_A_vtable** %this_vtable173
  %i168 = getelementptr %A* %_this1, i32 0, i32 2
  store i32 10, i32* %i168
  ret %A* %_this1
}
...
__fresh40:
  ...
  store i8* @_const_str30, i8** %_name164
  %this_vtable165 = getelementptr %Object* %_this1, i32 0, i32 0
  store %_Object_vtable* @_Object_vtable28, %_Object_vtable** %this_vtable165
  ret %Object* %_this1
}
