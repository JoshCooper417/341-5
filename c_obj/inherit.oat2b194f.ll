...
__fresh607:
  %x2734 = getelementptr %C* %_this1, i32 0, i32 2
  ...
  %y2738 = getelementptr %C* %_this1, i32 0, i32 3
  ...
  %z2742 = getelementptr %C* %_this1, i32 0, i32 4
  ...
  %w2746 = getelementptr %C* %_this1, i32 0, i32 5
...
__fresh605:
  ...
  %_name2722 = getelementptr %C* %_this1, i32 0, i32 1
  ...
  %w2714 = getelementptr %C* %_this1, i32 0, i32 5
...
__fresh604:
  %x2694 = getelementptr %B* %_this1, i32 0, i32 2
  ...
  %y2698 = getelementptr %B* %_this1, i32 0, i32 3
  ...
  %z2702 = getelementptr %B* %_this1, i32 0, i32 4
...
__fresh603:
  ...
  %_name2692 = getelementptr %B* %_this1, i32 0, i32 1
  ...
  %y2684 = getelementptr %B* %_this1, i32 0, i32 3
  %lhs_or_call2685 = load i32* %y_slot2681
  store i32 %lhs_or_call2685, i32* %y2684
  %z2686 = getelementptr %B* %_this1, i32 0, i32 4
...
__fresh602:
  %x2674 = getelementptr %A* %_this1, i32 0, i32 2
...
__fresh601:
  ...
  %_name2672 = getelementptr %A* %_this1, i32 0, i32 1
  ...
  %x2667 = getelementptr %A* %_this1, i32 0, i32 2
...
__fresh600:
  %_name2663 = getelementptr %Object* %_this1, i32 0, i32 1
