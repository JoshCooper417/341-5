...
__fresh299:
  ...
  %b1234 = getelementptr %C* %lhs_or_call1233, i32 0, i32 2
  ...
  %b1242 = getelementptr %C* %lhs_or_call1241, i32 0, i32 2
  %lhs_or_call1243 = load %B** %b1242
  %a1244 = getelementptr %B* %lhs_or_call1243, i32 0, i32 2
...
__fresh297:
  ...
  %_name1213 = getelementptr %C* %_this1, i32 0, i32 1
  store i8* @_const_str262, i8** %_name1213
  %b1214 = getelementptr %C* %_this1, i32 0, i32 2
...
__fresh295:
  ...
  %_name1204 = getelementptr %B* %_this1, i32 0, i32 1
  store i8* @_const_str260, i8** %_name1204
  %a1205 = getelementptr %B* %_this1, i32 0, i32 2
...
__fresh293:
  ...
  %_name1199 = getelementptr %A* %_this1, i32 0, i32 1
