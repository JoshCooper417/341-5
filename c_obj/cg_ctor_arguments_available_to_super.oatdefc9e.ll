...
@_const_str11.str. = private unnamed_addr constant [ 2 x i8 ] c "
\00", align 4
...
\00", align 4
@_const_str8 = alias bitcast([ 13 x i8 ]* @_const_str8.str. to i8*)@_const_str12.str. = private unnamed_addr constant [ 2 x i8 ] c "B\00", align 4
@_const_str12 = alias bitcast([ 2 x i8 ]* @_const_str12.str. to i8*)@_const_str6.str. = private unnamed_addr constant [ 2 x i8 ] c "
\00", align 4
...
define i32 @program (i32 %argc35, { i32, [ 0 x i8* ] }* %argv33){
__fresh4:
  %argc_slot36 = alloca i32
  store i32 %argc35, i32* %argc_slot36
  %argv_slot34 = alloca { i32, [ 0 x i8* ] }*
  store { i32, [ 0 x i8* ] }* %argv33, { i32, [ 0 x i8* ] }** %argv_slot34
  %mem_ptr37 = call i32* @oat_malloc ( i32 12 )
  %obj38 = bitcast i32* %mem_ptr37 to %B* 
  %new_obj39 = call %B* @_B_ctor ( %B* %obj38, i32 1, i32 2 )
  %vdecl_slot40 = alloca %B*
  store %B* %new_obj39, %B** %vdecl_slot40
  %lhs_or_call41 = load %B** %vdecl_slot40
  %x42 = getelementptr %B* %lhs_or_call41, i32 0, i32 2
  %lhs_or_call43 = load i32* %x42
  ret i32 %lhs_or_call43
}
...
__fresh3:
  ...
  %cast_op27 = bitcast %B* %_this1 to %A* 
  %mem_ptr28 = call i32* @oat_malloc ( i32 12 )
  %obj29 = bitcast i32* %mem_ptr28 to %B* 
  %new_obj30 = call %A* @_A_ctor ( %B* %obj29, %A* %cast_op27, i32 %bop26 )
  %_this1 = bitcast %A* %new_obj30 to %B 
  %_name31 = getelementptr %B* %_this1, i32 0, i32 1
  store i8* @_const_str12, i8** %_name31
  %this_vtable32 = getelementptr %B* %_this1, i32 0, i32 0
  store %_B_vtable* @_B_vtable3, %_B_vtable** %this_vtable32
