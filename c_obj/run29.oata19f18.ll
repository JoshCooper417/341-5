...
__bound_check5:
  %cast_op45 = bitcast %_C_vtable* @_C_vtable4 to i8** 
  %rvtable44 = load i8** %rvtable41
  %lvtable42 = load i8** %cast_op45
  %compare43 = icmp eq i8* %rvtable44, null
  br i1 %compare43, label %__end_no8, label %__check_curr7

__fresh12:
  br label %__check_curr7

__check_curr7:
  %compare43 = icmp eq i8** %lvtable42, %rvtable44
  br i1 %compare43, label %__end_yes9, label %__move_up6

__fresh13:
  br label %__move_up6

__move_up6:
  %rvtable41 = getelementptr i8* %rvtable44, i32 0
  br label %__bound_check5
...
__end_yes9:
  ...
  %lhs_or_call35 = load %C** %cast_ptr34
  %i36 = getelementptr %C* %lhs_or_call35, i32 0, i32 2
...
__end_no8:
  ...
  %lhs_or_call38 = load %A** %vdecl_slot31
  %i39 = getelementptr %A* %lhs_or_call38, i32 0, i32 2
  %lhs_or_call40 = load i32* %i39
  store i32 %lhs_or_call40, i32* %vdecl_slot33
  %lhs_or_call46 = load i32* %vdecl_slot33
  ret i32 %lhs_or_call46
}
