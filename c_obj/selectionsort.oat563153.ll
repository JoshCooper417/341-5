...
__fresh903:
  %arrayLength3690 = getelementptr %Array* %_this1, i32 0, i32 0, i32 2
...
__fresh894:
  ...
  %arrayLength3655 = getelementptr %Array* %_this1, i32 0, i32 0, i32 2
...
__then893:
  %headItem3658 = getelementptr %Array* %_this1, i32 0, i32 0, i32 3
...
__else892:
  %headItem3663 = getelementptr %Array* %_this1, i32 0, i32 0, i32 3
...
__cond884:
  ...
  %arrayLength3669 = getelementptr %Array* %_this1, i32 0, i32 0, i32 2
...
__body883:
  ...
  %nextItem3673 = getelementptr %ArrayItem* %lhs_or_call3672, i32 0, i32 0, i32 3
...
__post882:
  ...
  %nextItem3681 = getelementptr %ArrayItem* %lhs_or_call3680, i32 0, i32 0, i32 3
...
__merge891:
  %arrayLength3686 = getelementptr %Array* %_this1, i32 0, i32 0, i32 2
  %arrayLength3687 = getelementptr %Array* %_this1, i32 0, i32 0, i32 2
...
__fresh875:
  ...
  %headItem3634 = getelementptr %Array* %_this1, i32 0, i32 0, i32 3
...
__body867:
  ...
  %nextItem3643 = getelementptr %ArrayItem* %lhs_or_call3642, i32 0, i32 0, i32 3
...
__post866:
  ...
  %keyValue3651 = getelementptr %ArrayItem* %lhs_or_call3650, i32 0, i32 0, i32 2
...
__fresh859:
  ...
  %headItem3610 = getelementptr %Array* %_this1, i32 0, i32 0, i32 3
...
__body851:
  ...
  %nextItem3619 = getelementptr %ArrayItem* %lhs_or_call3618, i32 0, i32 0, i32 3
...
__post850:
  ...
  %keyValue3627 = getelementptr %ArrayItem* %lhs_or_call3626, i32 0, i32 0, i32 2
...
__fresh849:
  ...
  %_name3605 = getelementptr %Array* %_this1, i32 0, i32 0, i32 1
  ...
  %arrayLength3601 = getelementptr %Array* %_this1, i32 0, i32 0, i32 2
...
__fresh848:
  ...
  %keyValue3599 = getelementptr %ArrayItem* %_this1, i32 0, i32 0, i32 2
...
__fresh847:
  ...
  %_name3595 = getelementptr %ArrayItem* %_this1, i32 0, i32 0, i32 1
  ...
  %keyValue3588 = getelementptr %ArrayItem* %_this1, i32 0, i32 0, i32 2
  %lhs_or_call3589 = load i32* %x_slot3587
  store i32 %lhs_or_call3589, i32* %keyValue3588
  %nextItem3590 = getelementptr %ArrayItem* %_this1, i32 0, i32 0, i32 3
...
__fresh846:
  %_name3584 = getelementptr %Object* %_this1, i32 0, i32 0, i32 1
...
__fresh845:
  %_name3582 = getelementptr %Object* %_this1, i32 0, i32 0, i32 1
