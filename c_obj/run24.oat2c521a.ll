...
__fresh188:
  ...
  %_name745 = getelementptr %B* %_this1, i32 0, i32 0, i32 1
  store i8* @_const_str129, i8** %_name745
  %str746 = getelementptr %B* %_this1, i32 0, i32 0, i32 2
...
__fresh187:
  %str740 = getelementptr %A* %_this1, i32 0, i32 0, i32 2
...
__fresh186:
  ...
  %_name737 = getelementptr %A* %_this1, i32 0, i32 0, i32 1
  store i8* @_const_str127, i8** %_name737
  %str738 = getelementptr %A* %_this1, i32 0, i32 0, i32 2
...
__fresh185:
  %_name732 = getelementptr %Object* %_this1, i32 0, i32 0, i32 1
...
__fresh184:
  %_name730 = getelementptr %Object* %_this1, i32 0, i32 0, i32 1
