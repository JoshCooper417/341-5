...
__fresh7:
  ...
  %over34 = getelementptr %_A_vtable* @_A_vtable2, i32 0, i32 2
  %over33 = load i32 (%A*, i32)** %over34
  %cast_op35 = bitcast %A %lhs_or_call32 to %A* 
  %ret36 = call i32 %over33 ( %A* %cast_op35, i32 3 )
  ret i32 %ret36
}
