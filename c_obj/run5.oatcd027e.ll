...
__fresh51:
  ...
  %b213 = getelementptr %A* %lhs_or_call212, i32 0, i32 0, i32 2
...
__fresh47:
  ...
  %_name201 = getelementptr %A* %_this1, i32 0, i32 0, i32 1
  ...
  %b197 = getelementptr %A* %_this1, i32 0, i32 0, i32 2
  store i1 1, i1* %b197
  ret %A* %_this1
}
...
__fresh46:
  %_name195 = getelementptr %Object* %_this1, i32 0, i32 0, i32 1
...
__fresh45:
  %_name193 = getelementptr %Object* %_this1, i32 0, i32 0, i32 1
