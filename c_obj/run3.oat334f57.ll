...
__fresh6:
  %lhs_or_call33 = load %B* %_this1
  %cast_op34 = bitcast %B %lhs_or_call33 to %A* 
  %mem_ptr35 = call i32* @oat_malloc ( i32 12 )
  %obj36 = bitcast i32* %mem_ptr35 to %A* 
  %new_op32 = call %A* @_A_ctor ( %A* %obj36, %A* %cast_op34 )
...
__fresh2:
  %lhs_or_call12 = load %A* %_this1
  %cast_op13 = bitcast %A %lhs_or_call12 to %Object* 
  %mem_ptr14 = call i32* @oat_malloc ( i32 8 )
  %obj15 = bitcast i32* %mem_ptr14 to %Object* 
  %new_op11 = call %Object* @_Object_ctor ( %Object* %obj15, %Object* %cast_op13 )
...
__fresh1:
  %_name9 = getelementptr %Object* %_this1, i32 0, i32 1
  %lhs_or_call10 = load i8** %_name9
  ret i8* %lhs_or_call10
}


define %Object* @_Object_ctor (%Object* %_this1){
__fresh0:
  %new_op2 = call %Object* @_Object_ctor ( %Object* %obj4 )
  %_name5 = getelementptr %Object* %_this1, i32 0, i32 1
  %lhs_or_call6 = load %Object* %_this1
  %cast_op7 = bitcast %Object %lhs_or_call6 to i8* 
  store i8* %cast_op7, i8** %_name5
  %this_vtable8 = getelementptr %Object* %_this1, i32 0, i32 0
  store %Object* %_this1, %_Object_vtable* %this_vtable8
  ret %Object* %new_op2
}
