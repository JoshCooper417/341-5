...
__bound_check336:
  ...
  br i1 %compare1101, label %__end_no339, label %__check_curr338

__fresh345:
  br label %__check_curr338

__check_curr338:
  %compare1101 = icmp eq i8** %lvtable1100, %rvtable1102
  br i1 %compare1101, label %__end_yes340, label %__move_up337

__fresh346:
  br label %__move_up337
