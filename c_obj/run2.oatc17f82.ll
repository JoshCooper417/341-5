...
__fresh14:
  ...
  %vdecl_slot55 = alloca i32
  store i32 0, i32* %vdecl_slot55
  %lhs_or_call56 = load i32* %vdecl_slot55
  ret i32 %lhs_or_call56
}


define i32 @_B_g (%B* %_this1){
__fresh13:
  %i49 = getelementptr %B* %_this1, i32 0, i32 2
  %lhs_or_call50 = load i32* %i49
  ret i32 %lhs_or_call50
}


define %B* @_B_ctor (%B* %_this1){
__fresh12:
  %mem_ptr44 = call i32* @oat_malloc ( i32 16 )
  %obj45 = bitcast i32* %mem_ptr44 to %A* 
  %new_obj46 = call %A* @_A_ctor ( %A* %obj45 )
  %_this1 = bitcast %A* %new_obj46 to %B 
  %_name47 = getelementptr %B* %_this1, i32 0, i32 1
  store i8* @_const_str12, i8** %_name47
  %this_vtable48 = getelementptr %B* %_this1, i32 0, i32 0
  store %_B_vtable* @_B_vtable9, %_B_vtable** %this_vtable48
  ret %B* %_this1
}
...
__fresh9:
  %mem_ptr39 = call i32* @oat_malloc ( i32 8 )
  %obj40 = bitcast i32* %mem_ptr39 to %Object* 
  %new_obj41 = call %Object* @_Object_ctor ( %Object* %obj40 )
  %_this1 = bitcast %Object* %new_obj41 to %A 
  %_name42 = getelementptr %A* %_this1, i32 0, i32 1
  store i8* @_const_str11, i8** %_name42
  %this_vtable43 = getelementptr %A* %_this1, i32 0, i32 0
  store %_A_vtable* @_A_vtable8, %_A_vtable** %this_vtable43
  ret %A* %_this1
}
...
__fresh8:
  ...
  %lhs_or_call38 = load i8** %_name37
  ret i8* %lhs_or_call38
}


define %Object* @_Object_ctor (%Object* %_this1){
__fresh7:
  %_name35 = getelementptr %Object* %_this1, i32 0, i32 1
  store i8* @_const_str10, i8** %_name35
  %this_vtable36 = getelementptr %Object* %_this1, i32 0, i32 0
  store %_Object_vtable* @_Object_vtable7, %_Object_vtable** %this_vtable36
  ret %Object* %_this1
}
