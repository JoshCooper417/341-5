...
@_const_str4 = alias bitcast([ 7 x i8 ]* @_const_str4.str. to i8*)@_B_vtable3 = private constant %_B_vtable {%_A_vtable* @_A_vtable2, i8* (%Object*)* @_Object_get_name, i32 (%B*, i32)* @_B_over}, align 4
...
__fresh7:
  ...
  %lhs_or_call32 = load %A** @a7
  %vtable_ptr33 = getelementptr %A* %lhs_or_call32, i32 0
  %vtable34 = load %_A_vtable** %vtable_ptr33
  %over36 = getelementptr %_A_vtable* %vtable34, i32 0, i32 2
  %over35 = load i32 (%A*, i32)** %over36
  %cast_op37 = bitcast %A %lhs_or_call32 to %A* 
  %ret38 = call i32 %over35 ( %A* %cast_op37, i32 3 )
  ret i32 %ret38
}
...
__fresh6:
  %mem_ptr24 = call i32* @oat_malloc ( i32 8 )
  %obj25 = bitcast i32* %mem_ptr24 to %B* 
  %new_obj26 = call %B* @_B_ctor ( %B* %obj25 )
  %cast_op27 = bitcast %B* %new_obj26 to %A* 
  store %A* %cast_op27, %A** @a7
  ret void
}


define i32 @_B_over (%B* %_this1, i32 %x20){
__fresh5:
  %x_slot21 = alloca i32
  store i32 %x20, i32* %x_slot21
  %lhs_or_call22 = load i32* %x_slot21
  %bop23 = add i32 %lhs_or_call22, 2
  ret i32 %bop23
}
