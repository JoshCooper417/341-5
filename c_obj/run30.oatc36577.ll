...
__bound_check273:
  ...
  br i1 %compare958, label %__end_no276, label %__check_curr275

__fresh282:
  br label %__check_curr275

__check_curr275:
  %compare958 = icmp eq i8** %lvtable957, %rvtable959
  br i1 %compare958, label %__end_yes277, label %__move_up274

__fresh283:
  br label %__move_up274
