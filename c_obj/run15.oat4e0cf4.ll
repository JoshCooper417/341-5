...
__fresh147:
  ...
  %str570 = getelementptr %B* %lhs_or_call569, i32 0, i32 2
...
__fresh146:
  ...
  %_name559 = getelementptr %B* %_this1, i32 0, i32 1
...
__fresh145:
  ...
  %_name553 = getelementptr %A* %_this1, i32 0, i32 1
  store i8* @_const_str94, i8** %_name553
  %str554 = getelementptr %A* %_this1, i32 0, i32 2
...
__fresh144:
  %_name548 = getelementptr %Object* %_this1, i32 0, i32 1
...
__fresh143:
  %_name546 = getelementptr %Object* %_this1, i32 0, i32 1
