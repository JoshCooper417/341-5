...
__fresh472:
	...
	movl -4(%ebp), %eax
	movl %ecx, (%eax)
	jmp __bound_check467
__fresh473:
	jmp __bound_check467
__bound_check467:
	movl $__A_vtable379, %eax
	movl %eax, -24(%ebp)
	movl -32(%ebp), %eax
	movl (%eax), %ecx
	movl %ecx, -20(%ebp)
