...
__fresh32:
  ...
  %vtable_ptr149 = getelementptr %A* %lhs_or_call148, i32 0
  %vtable150 = load %_A_vtable** %vtable_ptr149
  %g152 = getelementptr %_A_vtable* %vtable150, i32 0, i32 3
  %g151 = load void (%A*)** %g152
  %cast_op153 = bitcast %A %lhs_or_call148 to %A* 
  call void %g151( %A* %cast_op153 )
  ret i32 0
}
...
__fresh29:
  ...
  store i8* @_const_str22, i8** %_name138
  %this_vtable139 = getelementptr %A* %_this1, i32 0, i32 0
  store %_A_vtable* @_A_vtable20, %_A_vtable** %this_vtable139
  ret %A* %_this1
}
...
__fresh27:
  ...
  store i8* @_const_str21, i8** %_name131
  %this_vtable132 = getelementptr %Object* %_this1, i32 0, i32 0
  store %_Object_vtable* @_Object_vtable19, %_Object_vtable** %this_vtable132
  ret %Object* %_this1
}
