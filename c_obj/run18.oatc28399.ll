...
define %A* @_A_ctor (%A* %_this1, i8* %str377){
__fresh90:
  %str_slot378 = alloca i8*
  store i8* %str377, i8** %str_slot378
  %cast_op379 = bitcast %A* %_this1 to %Object* 
  %mem_ptr380 = call i32* @oat_malloc ( i32 12 )
  %obj381 = bitcast i32* %mem_ptr380 to %A* 
  %new_obj382 = call %Object* @_Object_ctor ( %A* %obj381, %Object* %cast_op379 )
  ...
  %lhs_or_call385 = load i8** %str_slot378
...
__fresh89:
  %_name375 = getelementptr %Object* %_this1, i32 0, i32 1
  %lhs_or_call376 = load i8** %_name375
  ret i8* %lhs_or_call376
}


define %Object* @_Object_ctor (%Object* %_this1){
__fresh88:
  %_name373 = getelementptr %Object* %_this1, i32 0, i32 1
  store i8* @_const_str73, i8** %_name373
  %this_vtable374 = getelementptr %Object* %_this1, i32 0, i32 0
  store %_Object_vtable* @_Object_vtable71, %_Object_vtable** %this_vtable374
  ret %Object* %_this1
}
