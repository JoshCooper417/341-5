...
__bound_check249:
  ...
  br i1 %compare910, label %__end_no252, label %__check_curr251

__fresh257:
  br label %__check_curr251

__check_curr251:
  %compare910 = icmp eq i8** %lvtable909, %rvtable911
  br i1 %compare910, label %__end_yes253, label %__move_up250

__fresh258:
  br label %__move_up250
