...
__const_str573:
	.ascii "Object\0"
__Charmander_vtable572:
	.long __Pokemon_vtable570
...
__fresh672:
	...
	addl $0, %eax
	movl %eax, -8(%ebp)
	movl $__Charmander_vtable572, %eax
	movl %eax, %ecx
	movl -8(%ebp), %eax
	movl %ecx, (%eax)
	movl -20(%ebp), %eax
