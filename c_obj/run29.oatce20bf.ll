...
__fresh5:
  ...
  %lhs_or_call32 = load %A** %vdecl_slot31
  %i33 = getelementptr %A* %lhs_or_call32, i32 0, i32 2
  %lhs_or_call34 = load i32* %i33
  %vdecl_slot35 = alloca i32
  store i32 %lhs_or_call34, i32* %vdecl_slot35
  %lhs_or_call36 = load i32* %vdecl_slot35
  ret i32 %lhs_or_call36
}
