...
@a7 = global %B* zeroinitializer, align 4		; initialized by @a7.init8
...
__fresh6:
  ...
  %lhs_or_call27 = load %B** @a7
  %over29 = getelementptr %_B_vtable* @_B_vtable3, i32 0, i32 2
  %over28 = load i32 (%A*, i32)** %over29
  %cast_op30 = bitcast %B %lhs_or_call27 to %A* 
  %ret31 = call i32 %over28 ( %A* %cast_op30, i32 3 )
  ret i32 %ret31
}
