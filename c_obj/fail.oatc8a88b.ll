...
__fresh287:
  ...
  %lhs_or_call1158 = load i32* @x253
  %bop1159 = icmp eq i32 %lhs_or_call1158, 3
  br i1 %bop1159, label %__then286, label %__else285
...
__merge284:
  %lhs_or_call1160 = load i32* @x253
  ret i32 %lhs_or_call1160
}


define i8* @_Object_get_name (%Object* %_this1){
__fresh283:
  %_name1152 = getelementptr %Object* %_this1, i32 0, i32 1
  %lhs_or_call1153 = load i8** %_name1152
  ret i8* %lhs_or_call1153
}


define %Object* @_Object_ctor (%Object* %_this1){
__fresh282:
  %_name1150 = getelementptr %Object* %_this1, i32 0, i32 1
  store i8* @_const_str252, i8** %_name1150
  %this_vtable1151 = getelementptr %Object* %_this1, i32 0, i32 0
  store %_Object_vtable* @_Object_vtable251, %_Object_vtable** %this_vtable1151
  ret %Object* %_this1
}
