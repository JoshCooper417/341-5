...
__bound_check294:
  ...
  br i1 %compare1006, label %__end_no297, label %__check_curr296

__fresh303:
  br label %__check_curr296

__check_curr296:
  %compare1006 = icmp eq i8** %lvtable1005, %rvtable1007
  br i1 %compare1006, label %__end_yes298, label %__move_up295

__fresh304:
  br label %__move_up295
