...
__fresh57:
  ...
  store i8* @_const_str39, i8** %_name222
  %str223 = getelementptr %A* %_this1, i32 0, i32 2
  store i8* @_const_str40, i8** %str223
  %this_vtable224 = getelementptr %A* %_this1, i32 0, i32 0
  store %_A_vtable* @_A_vtable37, %_A_vtable** %this_vtable224
  ret %A* %_this1
}
...
__fresh55:
  ...
  store i8* @_const_str38, i8** %_name215
  %this_vtable216 = getelementptr %Object* %_this1, i32 0, i32 0
  store %_Object_vtable* @_Object_vtable36, %_Object_vtable** %this_vtable216
  ret %Object* %_this1
}
