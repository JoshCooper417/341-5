...
__bound_check5:
  %cast_op39 = bitcast %_C_vtable* @_C_vtable4 to i8** 
  %rvtable38 = load i8** %rvtable35
  %lvtable36 = load i8** %cast_op39
  %compare37 = icmp eq i8* %rvtable38, null
  br i1 %compare37, label %__end_no8, label %__check_curr7

__fresh12:
  br label %__check_curr7

__check_curr7:
  %compare37 = icmp eq i8** %lvtable36, %rvtable38
  br i1 %compare37, label %__end_yes9, label %__move_up6

__fresh13:
  br label %__move_up6

__move_up6:
  %rvtable35 = getelementptr i8* %rvtable38, i32 0
  br label %__bound_check5
...
__end_no8:
  %lhs_or_call40 = load i32* %vdecl_slot33
