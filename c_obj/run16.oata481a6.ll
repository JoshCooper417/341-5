...
__fresh158:
  ...
  %arr611 = getelementptr %B* %lhs_or_call610, i32 0, i32 2
...
__fresh157:
  ...
  %_name600 = getelementptr %B* %_this1, i32 0, i32 1
...
__fresh154:
  ...
  %_name579 = getelementptr %A* %_this1, i32 0, i32 1
  store i8* @_const_str101, i8** %_name579
  %arr580 = getelementptr %A* %_this1, i32 0, i32 2
...
__fresh150:
  %_name574 = getelementptr %Object* %_this1, i32 0, i32 1
...
__fresh149:
  %_name572 = getelementptr %Object* %_this1, i32 0, i32 1
