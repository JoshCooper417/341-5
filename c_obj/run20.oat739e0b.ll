...
__fresh175:
  ...
  %arr699 = getelementptr %B* %lhs_or_call698, i32 0, i32 2
...
__fresh174:
  ...
  %_name688 = getelementptr %B* %_this1, i32 0, i32 1
...
__fresh171:
  ...
  %_name657 = getelementptr %A* %_this1, i32 0, i32 1
  store i8* @_const_str114, i8** %_name657
  %arr658 = getelementptr %A* %_this1, i32 0, i32 2
...
__fresh167:
  %_name648 = getelementptr %Object* %_this1, i32 0, i32 1
...
__fresh166:
  %_name646 = getelementptr %Object* %_this1, i32 0, i32 1
