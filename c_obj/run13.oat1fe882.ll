...
__fresh133:
  ...
  %b517 = getelementptr %B* %lhs_or_call516, i32 0, i32 2
...
__fresh129:
  ...
  %_name504 = getelementptr %B* %_this1, i32 0, i32 1
...
__fresh128:
  ...
  %_name499 = getelementptr %A* %_this1, i32 0, i32 1
  ...
  %b495 = getelementptr %A* %_this1, i32 0, i32 2
  store i1 1, i1* %b495
  ret %A* %_this1
}
...
__fresh127:
  %_name493 = getelementptr %Object* %_this1, i32 0, i32 1
...
__fresh126:
  %_name491 = getelementptr %Object* %_this1, i32 0, i32 1
