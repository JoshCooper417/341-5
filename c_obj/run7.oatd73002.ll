...
__fresh65:
  ...
  store i8* @_const_str44, i8** %_name243
  ...
  %_tmp41247 = alloca i32
  store i32 10, i32* %_tmp41247
  %_tmp42248 = alloca { i32, [ 0 x i32 ] }*
  store { i32, [ 0 x i32 ] }* %array246, { i32, [ 0 x i32 ] }** %_tmp42248
...
__cond64:
  ...
  %lhs_or_call251 = load i32* %_tmp41247
...
__body63:
  %lhs_or_call253 = load { i32, [ 0 x i32 ] }** %_tmp42248
...
__post62:
  ...
  store %_A_vtable* @_A_vtable42, %_A_vtable** %this_vtable260
  ret %A* %_this1
}
...
__fresh60:
  ...
  store i8* @_const_str43, i8** %_name236
  %this_vtable237 = getelementptr %Object* %_this1, i32 0, i32 0
  store %_Object_vtable* @_Object_vtable41, %_Object_vtable** %this_vtable237
  ret %Object* %_this1
}
