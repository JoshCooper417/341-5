...
__fresh140:
  ...
  %obj542 = bitcast i32* %mem_ptr541 to %A* 
  %new_obj543 = call %A* @_A_ctor ( %A* %obj542 )
...
__fresh139:
  ...
  %i535 = getelementptr %A* %_this1, i32 0, i32 2
  store i32 10, i32* %i535
  ret %A* %_this1
}
...
__fresh138:
  %_name533 = getelementptr %Object* %_this1, i32 0, i32 1
  %lhs_or_call534 = load i8** %_name533
  ret i8* %lhs_or_call534
}
...
__fresh137:
  ...
  store i8* @_const_str98, i8** %_name531
  %this_vtable532 = getelementptr %Object* %_this1, i32 0, i32 0
  store %_Object_vtable* @_Object_vtable95, %_Object_vtable** %this_vtable532
  ret %Object* %_this1
}
