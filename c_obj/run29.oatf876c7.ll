...
@_const_str9.str. = private unnamed_addr constant [ 4 x i8 ] c "yes\00", align 4
...
__init5:
  ...
  %rvtable42 = getelementptr %A* %lhs_or_call35, i32 0
...
__bound_check6:
  ...
  %cast_vtable47 = bitcast i8** %rvtable42 to i8** 
  %rvtable45 = load i8** %cast_vtable47
  %compare44 = icmp eq i8* %rvtable45, null
  br i1 %compare44, label %__end_no9, label %__check_curr8
...
__check_curr8:
  ...
  br i1 %compare44, label %__end_yes10, label %__move_up7
