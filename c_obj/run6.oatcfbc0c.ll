...
__fresh58:
  ...
  %str235 = getelementptr %A* %lhs_or_call234, i32 0, i32 0, i32 2
...
__fresh57:
  ...
  %_name223 = getelementptr %A* %_this1, i32 0, i32 0, i32 1
  store i8* @_const_str39, i8** %_name223
  %str224 = getelementptr %A* %_this1, i32 0, i32 0, i32 2
...
__fresh56:
  %_name218 = getelementptr %Object* %_this1, i32 0, i32 0, i32 1
...
__fresh55:
  %_name216 = getelementptr %Object* %_this1, i32 0, i32 0, i32 1
