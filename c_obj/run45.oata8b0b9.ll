...
__fresh347:
  ...
  %arr1369 = getelementptr %A* %_this1, i32 0, i32 0, i32 5
...
__body342:
  ...
  %a1405 = getelementptr %A* %lhs_or_call1404, i32 0, i32 0, i32 2
  ...
  %b1415 = getelementptr %A* %lhs_or_call1414, i32 0, i32 0, i32 3
...
__fresh337:
  %a1360 = getelementptr %A* %_this1, i32 0, i32 0, i32 2
  %a1361 = getelementptr %A* %_this1, i32 0, i32 0, i32 2
  %lhs_or_call1362 = load i32* %a1361
  %bop1363 = add i32 %lhs_or_call1362, 1
  store i32 %bop1363, i32* %a1360
  %b1364 = getelementptr %A* %_this1, i32 0, i32 0, i32 3
  %b1365 = getelementptr %A* %_this1, i32 0, i32 0, i32 3
...
__fresh328:
  %o1326 = getelementptr %A* %_this1, i32 0, i32 0, i32 4
  ...
  %o1331 = getelementptr %A* %_this1, i32 0, i32 0, i32 4
...
__merge322:
  %arr1341 = getelementptr %A* %_this1, i32 0, i32 0, i32 5
...
__fresh316:
  ...
  %_name1322 = getelementptr %A* %_this1, i32 0, i32 0, i32 1
  store i8* @_const_str277, i8** %_name1322
  %a1323 = getelementptr %A* %_this1, i32 0, i32 0, i32 2
  store i32 1, i32* %a1323
  %b1324 = getelementptr %A* %_this1, i32 0, i32 0, i32 3
...
__fresh315:
  ...
  %_name1317 = getelementptr %O* %_this1, i32 0, i32 0, i32 1
...
__fresh314:
  %_name1312 = getelementptr %Object* %_this1, i32 0, i32 0, i32 1
...
__fresh313:
  %_name1310 = getelementptr %Object* %_this1, i32 0, i32 0, i32 1
