...
__fresh287:
  ...
  %lhs_or_call1189 = load i32* @x251
  %bop1190 = icmp eq i32 %lhs_or_call1189, 3
  br i1 %bop1190, label %__then286, label %__else285
...
__merge284:
  %lhs_or_call1191 = load i32* @x251
  ret i32 %lhs_or_call1191
}


define i8* @_Object_get_name (%Object* %_this1){
__fresh283:
  %_name1183 = getelementptr %Object* %_this1, i32 0, i32 0, i32 1
...
__fresh282:
  %_name1181 = getelementptr %Object* %_this1, i32 0, i32 0, i32 1
  store i8* @_const_str250, i8** %_name1181
  %this_vtable1182 = getelementptr %Object* %_this1, i32 0, i32 0
  store %_Object_vtable* @_Object_vtable249, %_Object_vtable** %this_vtable1182
  ret %Object* %_this1
}
