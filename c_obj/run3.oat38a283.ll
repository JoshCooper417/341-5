...
__fresh3:
  ...
  %_name22 = getelementptr %B* %_this1, i32 0, i32 1
  %lhs_or_call23 = load %B* %_this1
  %cast_op24 = bitcast %B %lhs_or_call23 to i8* 
  store i8* %cast_op24, i8** %_name22
  %this_vtable25 = getelementptr %B* %_this1, i32 0, i32 0
  store %B* %_this1, %_B_vtable* %this_vtable25
  ret %B* %_this1
}
...
__fresh2:
  ...
  %_name13 = getelementptr %C* %_this1, i32 0, i32 1
  %lhs_or_call14 = load %C* %_this1
  %cast_op15 = bitcast %C %lhs_or_call14 to i8* 
  store i8* %cast_op15, i8** %_name13
  %this_vtable16 = getelementptr %C* %_this1, i32 0, i32 0
  store %C* %_this1, %_C_vtable* %this_vtable16
  ret %C* %_this1
}
