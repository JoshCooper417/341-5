...
__bound_check5:
  %cast_op43 = bitcast %_C_vtable* @_C_vtable4 to i8** 
  %rvtable42 = load i8** %rvtable39
  %lvtable40 = load i8** %cast_op43
  %compare41 = icmp eq i8* %rvtable42, null
  br i1 %compare41, label %__end_no8, label %__check_curr7

__fresh12:
  br label %__check_curr7

__check_curr7:
  %compare41 = icmp eq i8** %lvtable40, %rvtable42
  br i1 %compare41, label %__end_yes9, label %__move_up6

__fresh13:
  br label %__move_up6

__move_up6:
  %rvtable39 = getelementptr i8* %rvtable42, i32 0
  br label %__bound_check5
...
__end_no8:
  ...
  %lhs_or_call36 = load %A** %vdecl_slot31
  %i37 = getelementptr %A* %lhs_or_call36, i32 0, i32 2
  %lhs_or_call38 = load i32* %i37
  store i32 %lhs_or_call38, i32* %vdecl_slot33
  %lhs_or_call44 = load i32* %vdecl_slot33
