...
@_const_str13.str. = private unnamed_addr constant [ 2 x i8 ] c "
\00", align 4
@_const_str13 = alias bitcast([ 2 x i8 ]* @_const_str13.str. to i8*)@_const_str12.str. = private unnamed_addr constant [ 2 x i8 ] c "
\00", align 4
@_const_str12 = alias bitcast([ 2 x i8 ]* @_const_str12.str. to i8*)@_const_str11.str. = private unnamed_addr constant [ 6 x i8 ] c "b.i: \00", align 4
@_const_str11 = alias bitcast([ 6 x i8 ]* @_const_str11.str. to i8*)@_const_str10.str. = private unnamed_addr constant [ 2 x i8 ] c "
\00", align 4
@_const_str10 = alias bitcast([ 2 x i8 ]* @_const_str10.str. to i8*)@_const_str9.str. = private unnamed_addr constant [ 6 x i8 ] c "b.j: \00", align 4
@_const_str9 = alias bitcast([ 6 x i8 ]* @_const_str9.str. to i8*)@_const_str8.str. = private unnamed_addr constant [ 2 x i8 ] c "
\00", align 4
@_const_str8 = alias bitcast([ 2 x i8 ]* @_const_str8.str. to i8*)@_const_str7.str. = private unnamed_addr constant [ 2 x i8 ] c "
\00", align 4
@_const_str7 = alias bitcast([ 2 x i8 ]* @_const_str7.str. to i8*)@_const_str6.str. = private unnamed_addr constant [ 6 x i8 ] c "b.i: \00", align 4
@_const_str6 = alias bitcast([ 6 x i8 ]* @_const_str6.str. to i8*)@_const_str5.str. = private unnamed_addr constant [ 2 x i8 ] c "
\00", align 4
@_const_str5 = alias bitcast([ 2 x i8 ]* @_const_str5.str. to i8*)@_const_str4.str. = private unnamed_addr constant [ 6 x i8 ] c "b.j: \00", align 4
@_const_str4 = alias bitcast([ 6 x i8 ]* @_const_str4.str. to i8*)@_B_vtable3 = private constant %_B_vtable {%_A_vtable* @_A_vtable2, i8* (%Object*)* @_Object_get_name, void (%A*)* @_A_x, void (%A*)* @_A_g, void (%B*)* @_B_f, i32 (%B*, i32)* @_B_h}, align 4
...
__fresh9:
  ...
  %vdecl_slot68 = alloca i32
  store i32 0, i32* %vdecl_slot68
  call void @print_string( i8* @_const_str4 )
  %lhs_or_call69 = load %B** %vdecl_slot67
  %j70 = getelementptr %B* %lhs_or_call69, i32 0, i32 3
  %lhs_or_call71 = load i32* %j70
  call void @print_int( i32 %lhs_or_call71 )
  call void @print_string( i8* @_const_str5 )
  call void @print_string( i8* @_const_str6 )
  call void @print_string( i8* @_const_str7 )
  %lhs_or_call72 = load %B** %vdecl_slot67
  %i73 = getelementptr %B* %lhs_or_call72, i32 0, i32 2
  %lhs_or_call74 = load i32* %i73
  call void @print_int( i32 %lhs_or_call74 )
  call void @print_string( i8* @_const_str8 )
  %lhs_or_call75 = load %B** %vdecl_slot67
  %h77 = getelementptr %_B_vtable* @_B_vtable3, i32 0, i32 5
  %h76 = load i32 (%B*, i32)** %h77
  %cast_op78 = bitcast %B %lhs_or_call75 to %B* 
  %ret79 = call i32 %h76 ( %B* %cast_op78, i32 3 )
  store i32 %ret79, i32* %vdecl_slot68
  call void @print_string( i8* @_const_str9 )
  %lhs_or_call80 = load %B** %vdecl_slot67
  %j81 = getelementptr %B* %lhs_or_call80, i32 0, i32 3
  %lhs_or_call82 = load i32* %j81
  call void @print_int( i32 %lhs_or_call82 )
  call void @print_string( i8* @_const_str10 )
  call void @print_string( i8* @_const_str11 )
  call void @print_string( i8* @_const_str12 )
  %lhs_or_call83 = load %B** %vdecl_slot67
  %i84 = getelementptr %B* %lhs_or_call83, i32 0, i32 2
  %lhs_or_call85 = load i32* %i84
  call void @print_int( i32 %lhs_or_call85 )
  call void @print_string( i8* @_const_str13 )
  %lhs_or_call86 = load i32* %vdecl_slot68
  ret i32 %lhs_or_call86
}
...
__fresh6:
  ...
  %mem_ptr34 = call i32* @oat_malloc ( i32 16 )
  %obj35 = bitcast i32* %mem_ptr34 to %B* 
  %new_obj36 = call %A* @_A_ctor ( %B* %obj35, %A* %cast_op33 )
