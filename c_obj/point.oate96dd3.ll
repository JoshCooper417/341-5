...
__fresh637:
  ...
  %x2874 = getelementptr %Point* %lhs_or_call2873, i32 0, i32 0, i32 2
...
__fresh636:
  ...
  %x2847 = getelementptr %Point* %_this1, i32 0, i32 0, i32 2
  %x2848 = getelementptr %Point* %_this1, i32 0, i32 0, i32 2
  ...
  %y2852 = getelementptr %Point* %_this1, i32 0, i32 0, i32 3
  %y2853 = getelementptr %Point* %_this1, i32 0, i32 0, i32 3
...
__fresh635:
  ...
  %_name2841 = getelementptr %Point* %_this1, i32 0, i32 0, i32 1
  ...
  %x2836 = getelementptr %Point* %_this1, i32 0, i32 0, i32 2
  store i32 0, i32* %x2836
  %y2837 = getelementptr %Point* %_this1, i32 0, i32 0, i32 3
...
__fresh634:
  %_name2834 = getelementptr %Object* %_this1, i32 0, i32 0, i32 1
...
__fresh633:
  %_name2832 = getelementptr %Object* %_this1, i32 0, i32 0, i32 1
