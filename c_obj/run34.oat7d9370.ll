...
__bound_check315:
  ...
  br i1 %compare1053, label %__end_no318, label %__check_curr317

__fresh324:
  br label %__check_curr317

__check_curr317:
  %compare1053 = icmp eq i8** %lvtable1052, %rvtable1054
  br i1 %compare1053, label %__end_yes319, label %__move_up316

__fresh325:
  br label %__move_up316
