...
__fresh832:
  %voice3449 = getelementptr %Charmander* %_this1, i32 0, i32 0, i32 3
...
__fresh831:
  ...
  %voice3439 = getelementptr %Charmander* %_this1, i32 0, i32 0, i32 3
  %lhs_or_call3440 = load i8** %voice3439
  call void @print_string( i8* %lhs_or_call3440 )
  %speed3441 = getelementptr %Charmander* %_this1, i32 0, i32 0, i32 4
...
__fresh830:
  ...
  %_name3434 = getelementptr %Charmander* %_this1, i32 0, i32 0, i32 1
  store i8* @_const_str588, i8** %_name3434
  %voice3435 = getelementptr %Charmander* %_this1, i32 0, i32 0, i32 3
  ...
  %speed3430 = getelementptr %Charmander* %_this1, i32 0, i32 0, i32 4
...
__fresh829:
  %voice3428 = getelementptr %Pikachu* %_this1, i32 0, i32 0, i32 3
...
__fresh828:
  ...
  %voice3418 = getelementptr %Pikachu* %_this1, i32 0, i32 0, i32 3
  %lhs_or_call3419 = load i8** %voice3418
  call void @print_string( i8* %lhs_or_call3419 )
  %speed3420 = getelementptr %Pikachu* %_this1, i32 0, i32 0, i32 4
...
__fresh827:
  ...
  %_name3414 = getelementptr %Pikachu* %_this1, i32 0, i32 0, i32 1
  ...
  %speed3409 = getelementptr %Pikachu* %_this1, i32 0, i32 0, i32 4
  store i32 25, i32* %speed3409
  %voice3410 = getelementptr %Pikachu* %_this1, i32 0, i32 0, i32 3
...
__fresh826:
  ...
  %life3402 = getelementptr %Pokemon* %_this1, i32 0, i32 0, i32 2
  %life3403 = getelementptr %Pokemon* %_this1, i32 0, i32 0, i32 2
  ...
  %voice3407 = getelementptr %Pokemon* %_this1, i32 0, i32 0, i32 3
...
__fresh825:
  ...
  %_name3397 = getelementptr %Pokemon* %_this1, i32 0, i32 0, i32 1
  store i8* @_const_str583, i8** %_name3397
  %voice3398 = getelementptr %Pokemon* %_this1, i32 0, i32 0, i32 3
  ...
  %life3393 = getelementptr %Pokemon* %_this1, i32 0, i32 0, i32 2
...
__fresh824:
  %_name3391 = getelementptr %Object* %_this1, i32 0, i32 0, i32 1
...
__fresh823:
  %_name3389 = getelementptr %Object* %_this1, i32 0, i32 0, i32 1
