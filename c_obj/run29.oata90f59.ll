...
__bound_check5:
  %cast_op42 = bitcast %_C_vtable* @_C_vtable4 to i8** 
  %rvtable41 = load i8** %rvtable38
  %lvtable39 = load i8** %cast_op42
  %compare40 = icmp eq i8* %rvtable41, null
  br i1 %compare40, label %__end_no8, label %__check_curr7

__fresh12:
  br label %__check_curr7

__check_curr7:
  %compare40 = icmp eq i8** %lvtable39, %rvtable41
  br i1 %compare40, label %__end_yes9, label %__move_up6

__fresh13:
  br label %__move_up6

__move_up6:
  %rvtable38 = getelementptr i8* %rvtable41, i32 0
  br label %__bound_check5
...
__end_no8:
  ...
  %i36 = getelementptr %A* %lhs_or_call35, i32 0, i32 2
  %lhs_or_call37 = load i32* %i36
  store i32 %lhs_or_call37, i32* %vdecl_slot33
  %lhs_or_call43 = load i32* %vdecl_slot33
