...
__fresh212:
  ...
  %vdecl_slot830 = alloca i8*
  store i8* null, i8** %vdecl_slot830
  %lhs_or_call831 = load i8** %vdecl_slot830
  %ifnull_slot832 = alloca i8*
  store i8* %lhs_or_call831, i8** %ifnull_slot832
  %ifnull_guard833 = icmp ne i8* %lhs_or_call831, null
  br i1 %ifnull_guard833, label %__then211, label %__else210
...
__fresh208:
  ...
  %lhs_or_call825 = load i8** %_name824
  ret i8* %lhs_or_call825
}


define %Object* @_Object_ctor (%Object* %_this1){
__fresh207:
  %_name822 = getelementptr %Object* %_this1, i32 0, i32 1
  store i8* @_const_str147, i8** %_name822
  %this_vtable823 = getelementptr %Object* %_this1, i32 0, i32 0
  store %_Object_vtable* @_Object_vtable146, %_Object_vtable** %this_vtable823
  ret %Object* %_this1
}
