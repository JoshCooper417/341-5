...
__fresh68:
  ...
  %arr271 = getelementptr %A* %lhs_or_call270, i32 0, i32 0, i32 2
...
__fresh65:
  ...
  %_name244 = getelementptr %A* %_this1, i32 0, i32 0, i32 1
  store i8* @_const_str44, i8** %_name244
  %arr245 = getelementptr %A* %_this1, i32 0, i32 0, i32 2
...
__fresh61:
  %_name239 = getelementptr %Object* %_this1, i32 0, i32 0, i32 1
...
__fresh60:
  %_name237 = getelementptr %Object* %_this1, i32 0, i32 0, i32 1
