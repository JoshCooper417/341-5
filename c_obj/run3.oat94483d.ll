...
@_const_str8.str. = private unnamed_addr constant [ 2 x i8 ] c "
\00", align 4
...
__fresh9:
  ...
  %i72 = getelementptr %B* %lhs_or_call71, i32 0, i32 2
  %lhs_or_call73 = load i32* %i72
  call void @print_int( i32 %lhs_or_call73 )
  call void @print_string( i8* @_const_str8 )
  %lhs_or_call74 = load %B** %vdecl_slot67
  %h76 = getelementptr %_B_vtable* @_B_vtable3, i32 0, i32 5
  %h75 = load i32 (%B*, i32)** %h76
  %cast_op77 = bitcast %B %lhs_or_call74 to %B* 
  %ret78 = call i32 %h75 ( %B* %cast_op77, i32 3 )
  ret i32 %ret78
}
