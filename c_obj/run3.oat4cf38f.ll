...
__fresh25:
  ...
  %j122 = getelementptr %B* %lhs_or_call121, i32 0, i32 3
  %lhs_or_call123 = load i32* %j122
  call void @print_int( i32 %lhs_or_call123 )
  call void @print_string( i8* @_const_str21 )
  call void @print_string( i8* @_const_str22 )
  call void @print_string( i8* @_const_str23 )
  %lhs_or_call124 = load %B** %vdecl_slot119
  %i125 = getelementptr %B* %lhs_or_call124, i32 0, i32 2
  %lhs_or_call126 = load i32* %i125
  call void @print_int( i32 %lhs_or_call126 )
  call void @print_string( i8* @_const_str24 )
  %lhs_or_call127 = load %B** %vdecl_slot119
  %vtable_ptr128 = getelementptr %B* %lhs_or_call127, i32 0
  %vtable129 = load %_B_vtable** %vtable_ptr128
  %h131 = getelementptr %_B_vtable* %vtable129, i32 0, i32 5
  %h130 = load i32 (%B*, i32)** %h131
  %cast_op132 = bitcast %B %lhs_or_call127 to %B* 
  %ret133 = call i32 %h130 ( %B* %cast_op132, i32 3 )
  store i32 %ret133, i32* %vdecl_slot120
  call void @print_string( i8* @_const_str25 )
  %lhs_or_call134 = load %B** %vdecl_slot119
  %j135 = getelementptr %B* %lhs_or_call134, i32 0, i32 3
  %lhs_or_call136 = load i32* %j135
  ...
  %lhs_or_call137 = load %B** %vdecl_slot119
  %i138 = getelementptr %B* %lhs_or_call137, i32 0, i32 2
  %lhs_or_call139 = load i32* %i138
  call void @print_int( i32 %lhs_or_call139 )
  call void @print_string( i8* @_const_str29 )
  %lhs_or_call140 = load i32* %vdecl_slot120
  ret i32 %lhs_or_call140
}
...
__fresh22:
  ...
  store i8* @_const_str19, i8** %_name87
