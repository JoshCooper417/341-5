...
__fresh106:
  ...
  %f448 = getelementptr %_A_vtable* @_A_vtable81, i32 0, i32 2
  %f447 = load i8* (%A*)** %f448
  %cast_op449 = bitcast %A %lhs_or_call446 to %A* 
  %ret450 = call i8* %f447 ( %A* %cast_op449 )
  %ifnull_slot451 = alloca i8*
  store i8* %ret450, i8** %ifnull_slot451
  %ifnull_guard452 = icmp ne i8* %ret450, null
  br i1 %ifnull_guard452, label %__then105, label %__else104

__fresh107:
  br label %__then105

__then105:
  %lhs_or_call453 = load i8** %ifnull_slot451
  call void @print_string( i8* %lhs_or_call453 )
  br label %__merge103
...
__fresh101:
  %cast_op429 = bitcast %A* %_this1 to %Object* 
  %mem_ptr430 = call i32* @oat_malloc ( i32 12 )
  %obj431 = bitcast i32* %mem_ptr430 to %A* 
  %new_obj432 = call %Object* @_Object_ctor ( %A* %obj431, %Object* %cast_op429 )
...
__fresh100:
  %_name427 = getelementptr %Object* %_this1, i32 0, i32 1
  %lhs_or_call428 = load i8** %_name427
  ret i8* %lhs_or_call428
}


define %Object* @_Object_ctor (%Object* %_this1){
__fresh99:
  %_name425 = getelementptr %Object* %_this1, i32 0, i32 1
  store i8* @_const_str82, i8** %_name425
  %this_vtable426 = getelementptr %Object* %_this1, i32 0, i32 0
  store %_Object_vtable* @_Object_vtable80, %_Object_vtable** %this_vtable426
  ret %Object* %_this1
}
