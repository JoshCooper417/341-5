...
__bound_check5:
  %cast_op40 = bitcast %_C_vtable* @_C_vtable4 to i8** 
  %rvtable39 = load i8** %rvtable36
  %lvtable37 = load i8** %cast_op40
  %compare38 = icmp eq i8* %rvtable39, null
  br i1 %compare38, label %__end_no8, label %__check_curr7

__fresh12:
  br label %__check_curr7

__check_curr7:
  %compare38 = icmp eq i8** %lvtable37, %rvtable39
  br i1 %compare38, label %__end_yes9, label %__move_up6

__fresh13:
  br label %__move_up6

__move_up6:
  %rvtable36 = getelementptr i8* %rvtable39, i32 0
  br label %__bound_check5
...
__end_no8:
  %lhs_or_call41 = load i32* %vdecl_slot33
