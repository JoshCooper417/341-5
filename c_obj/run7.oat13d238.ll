...
__fresh65:
  %cast_op251 = bitcast %A* %_this1 to %Object* 
  %mem_ptr252 = call i32* @oat_malloc ( i32 12 )
  %obj253 = bitcast i32* %mem_ptr252 to %A* 
  %new_obj254 = call %Object* @_Object_ctor ( %A* %obj253, %Object* %cast_op251 )
...
__fresh61:
  ...
  %lhs_or_call250 = load i8** %_name249
  ret i8* %lhs_or_call250
}


define %Object* @_Object_ctor (%Object* %_this1){
__fresh60:
  %_name247 = getelementptr %Object* %_this1, i32 0, i32 1
  store i8* @_const_str54, i8** %_name247
  %this_vtable248 = getelementptr %Object* %_this1, i32 0, i32 0
  store %_Object_vtable* @_Object_vtable52, %_Object_vtable** %this_vtable248
  ret %Object* %_this1
}
