...
@_const_str9.str. = private unnamed_addr constant [ 3 x i8 ] c "no\00", align 4
@_const_str9 = alias bitcast([ 3 x i8 ]* @_const_str9.str. to i8*)@_const_str8.str. = private unnamed_addr constant [ 2 x i8 ] c "C\00", align 4
...
__bound_check5:
  %cast_op44 = bitcast %_C_vtable* @_C_vtable4 to i8** 
  %rvtable43 = load i8** %rvtable40
  %lvtable41 = load i8** %cast_op44
  %compare42 = icmp eq i8* %rvtable43, null
  br i1 %compare42, label %__end_no8, label %__check_curr7

__fresh12:
  br label %__check_curr7

__check_curr7:
  %compare42 = icmp eq i8** %lvtable41, %rvtable43
  br i1 %compare42, label %__end_yes9, label %__move_up6

__fresh13:
  br label %__move_up6

__move_up6:
  %rvtable40 = getelementptr i8* %rvtable43, i32 0
  br label %__bound_check5
...
__end_yes9:
  ...
  %cast_op36 = bitcast %A* %lhs_or_call35 to %C* 
  store %C* %cast_op36, %C** %cast_ptr34
  br label %__end_no8

__end_no8:
  call void @print_string( i8* @_const_str9 )
  %lhs_or_call37 = load %A** %vdecl_slot31
  %i38 = getelementptr %A* %lhs_or_call37, i32 0, i32 2
  %lhs_or_call39 = load i32* %i38
  store i32 %lhs_or_call39, i32* %vdecl_slot33
  %lhs_or_call45 = load i32* %vdecl_slot33
  ret i32 %lhs_or_call45
}
