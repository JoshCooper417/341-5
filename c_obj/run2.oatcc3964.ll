...
__fresh12:
  %cast_op47 = bitcast %B* %_this1 to %A* 
  %mem_ptr48 = call i32* @oat_malloc ( i32 16 )
  %obj49 = bitcast i32* %mem_ptr48 to %B* 
  %new_obj50 = call %A* @_A_ctor ( %B* %obj49, %A* %cast_op47 )
...
__fresh9:
  %cast_op41 = bitcast %A* %_this1 to %Object* 
  %mem_ptr42 = call i32* @oat_malloc ( i32 16 )
  %obj43 = bitcast i32* %mem_ptr42 to %A* 
  %new_obj44 = call %Object* @_Object_ctor ( %A* %obj43, %Object* %cast_op41 )
  %_this1 = bitcast %Object* %new_obj44 to %A 
  %_name45 = getelementptr %A* %_this1, i32 0, i32 1
